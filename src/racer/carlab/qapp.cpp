...
#endif
#ifdef linux
  sysFont=new QFont("helvetica",12);
#endif
#ifdef __sgi
...
#ifdef WIN32
  //sysFontNP=new QFont("courier",16,QFONT_SLANT_DONTCARE,QFONT_WEIGHT_BOLD);
  sysFontNP=new QFont("arial",14);
#endif
#ifdef linux
  sysFontNP=new QFont("courier",11,QFONT_SLANT_ROMAN);
#endif
#ifdef __sgi
