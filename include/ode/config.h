...
// RvG 4-2-01; extra include to get it compiling. Note this is a v0.025
// .h file in the 0.03 ODE release, so I might have had to run configurator.c.
// typedef size_t
#include <stdio.h>
// va_list
//#include <stdarg.h>
...
// HUGE
#include <math.h>
// intP; must be sizeof(void*) (32-bit assumed)
typedef int intP;
